...
def object_detail(request, year, month, day, queryset, date_field,
    ...
    if obj.categories.title == 'network':
        ...
        userena_object.increase_system_num()
    elif obj.categories.title == 'database':
        userena_object.increase_database_num()
    elif obj.categories.title == 'other':
        userena_object.increase_other_num()
